...
public abstract class Sticker {
  ...
  private boolean isNew; //새로 생성한 스티커 true, 기존 스티커 false
  ...
  @NonNull public Sticker setIsNew(boolean isNew) {
    this.isNew = isNew;
    return this;
  }
  ...
  @NonNull public Sticker setId(long id) {
    this.id = id;
    return this;
  }
  ...
  @NonNull public Sticker setStickerId(int stickerId) {
